...
El fichero principal de la plantilla es `tfg.tex`. Al inicio del mismo (entre las líneas 17-30) es necesario modificar los datos del TFG: título, autor, grado, facultad y tutores mediante los comandos `\titulo`, `\autor`, `\grado`, `\facultad`, `\universidad`, `\curso` `\tutor`.
