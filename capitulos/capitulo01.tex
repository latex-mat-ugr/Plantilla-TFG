...
\begin{equation}\label{eq:identidad-pitagorica}
  \cos^2 x + \sin^2 x = 1,
\end{equation}
o bien este otro: la fórmula de Gauss-Bonnet para una superficie compacta $S$ viene dada por:
\begin{equation}
  \int_S K = 2\pi\chi(S)
\end{equation}
...
Esto es un ejemplo de texto en un capítulo. Incluye varias citas tanto a libros~\cite{Euler1982, Euler1984, Euler1985, Aigner2018} como a recursos online~\cite{EulerWiki} (páginas web). Ver el fichero \texttt{library.bib}. 
